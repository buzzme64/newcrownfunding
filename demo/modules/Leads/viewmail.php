...
<tr><td style='text-align:center;' class='western'>
	<font color='#000080'><span lang='zxx'><u><a href='http://www.yourwebsite.com/' target='_blank'>www.crownfundinggroupinc.com.com</a></u></span></font></td></tr>
</table>";
		...
		if (count($_POST)>0){
			...
			send_mail('Leads',$_POST['to'],$assignedusername,$assignedemail,$_POST['subject'],$_POST['emailbody'], $_POST['cc'], $_POST['bcc'],'','','');
