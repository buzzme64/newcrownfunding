<?php /* Smarty version 2.6.18, created on 2013-10-08 02:15:40
...
<?php if ($this->_tpl_vars['entityName'] == 'Leads'): ?>
<table>
	<tr>
		<td>&nbsp</td>
	</tr>	
	<tr>
		<td><input type="checkbox" id="usepdf" name="usepdf"<?php if ($this->_tpl_vars['task']->usepdf == '1'): ?> checked="" <?php endif; ?>><b><?php echo $this->_tpl_vars['MOD']['LBL_USEPDF']; ?>
</b></td>	
	</tr>
	<tr>
		<td>&nbsp</td>
	...
	<tr>
		<td><input type="checkbox" id="usepdf" name="sendcontract"<?php if ($this->_tpl_vars['task']->sendcontract == '1'): ?> checked="" <?php endif; ?>><b>Send Contract to Lead</b></td>	
	</tr>
</table>
<?php endif; ?>
