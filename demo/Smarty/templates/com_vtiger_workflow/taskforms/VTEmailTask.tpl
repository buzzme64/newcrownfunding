...
{if $entityName eq 'Leads'}
<table>
	<tr>
		<td>&nbsp</td>
	</tr>	
	<tr>
		<td><input type="checkbox" id="usepdf" name="usepdf"{if $task->usepdf eq '1'} checked="" {/if}><b>{$MOD.LBL_USEPDF}</b></td>	
	</tr>
	<tr>
		<td>&nbsp</td>
	</tr>	
	<tr>
		<td><input type="checkbox" id="usepdf" name="sendcontract"{if $task->sendcontract eq '1'} checked="" {/if}><b>Send Contract to Lead</b></td>	
	</tr>
</table>
{/if}
