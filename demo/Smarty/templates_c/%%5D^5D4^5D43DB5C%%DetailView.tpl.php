<?php /* Smarty version 2.6.18, created on 2015-06-02 16:56:10
         compiled from DetailView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'vtlib_purify', 'DetailView.tpl', 26, false),array('modifier', 'vtiger_imageurl', 'DetailView.tpl', 193, false),array('modifier', 'getTranslatedString', 'DetailView.tpl', 204, false),array('modifier', 'count', 'DetailView.tpl', 219, false),array('modifier', 'replace', 'DetailView.tpl', 360, false),)), $this); ?>
...
<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => 'DetailViewSearch.tpl', 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
...
?>
																		...
																		<?php if ($this->_tpl_vars['MODULE'] == 'Leads' && $this->_tpl_vars['header'] == 'Business Information'): ?>
																		...
																		<?php endif; ?>
																		<?php if ($this->_tpl_vars['MODULE'] == 'Leads' && $this->_tpl_vars['header'] == 'Funded'): ?>
																			<?php echo $this->_tpl_vars['ALLFUNDED']; ?>

																		<?php else: ?>
																				<!-- Detailed View Code starts here-->
																				<?php if ($this->_tpl_vars['MODULE'] == 'Leads' && $this->_tpl_vars['header'] == 'LEAD STATUS'): ?>
																					<table border=0 cellspacing=0 cellpadding=0 width=100% class="small" style='font-size:12px;'>
																				<?php elseif ($this->_tpl_vars['MODULE'] == 'Leads' && $this->_tpl_vars['header'] == 'Description Information'): ?>
...
?>
																											...
																											<?php if ($this->_tpl_vars['MODULE'] == 'Leads'): ?>
																												<?php $this->assign('tdstyle', $this->_tpl_vars['data']['tdstyle']); ?>
																											<?php else: ?>
...
></input> <?php echo getTranslatedString('LBL_TIMEFIELD'); ?>
																													...
																													<?php elseif ($this->_tpl_vars['MODULE'] == 'Leads' && $this->_tpl_vars['header'] == 'LEAD STATUS'): ?>
																													<td class="dvtCellLabel" align=right width=10%><input type="hidden" id="hdtxt_IsAdmin" value=<?php echo $this->_tpl_vars['keyadmin']; ?>
></input><?php echo $this->_tpl_vars['label']; ?>
</td>
																													<?php else: ?>
																													<td class="dvtCellLabel" align=right width=25%><input type="hidden" id="hdtxt_IsAdmin" value=<?php echo $this->_tpl_vars['keyadmin']; ?>
...
unset($_smarty_tpl_vars);
 ?>
																					...
																					<?php endif; ?>
																				<?php if ($this->_tpl_vars['MODULE'] == 'Leads' && $this->_tpl_vars['header'] == 'OTHER INFORMATION'): ?>
																					</td></tr></table></div>
																				<?php endif; ?>
																				<?php endif; ?>
																			</td>
...
"/>
																		<?php endforeach; endif; unset($_from); ?>
																		<a href="javascript:void(0);" class="webMnu" onclick="sendemailpdf(<?php echo $this->_tpl_vars['ID']; ?>
)"><img src="<?php echo vtiger_imageurl('sendmail.png', $this->_tpl_vars['THEME']); ?>
" hspace="5" align="absmiddle"  border="0"/></a>&nbsp;
																		<a href="javascript:void(0);" class="webMnu" onclick="sendemailpdf(<?php echo $this->_tpl_vars['ID']; ?>
)"><?php echo $this->_tpl_vars['APP']['LBL_SENDMAIL_BUTTON_LABEL']; ?>
 PDF app</a>
																...
																<a href="javascript:void(0);" class="webMnu" onclick="sendemailbusinesspdf(<?php echo $this->_tpl_vars['ID']; ?>
)"><img src="<?php echo vtiger_imageurl('sendmail.png', $this->_tpl_vars['THEME']); ?>
" hspace="5" align="absmiddle"  border="0"/></a>&nbsp;
																		<a href="javascript:void(0);" class="webMnu" onclick="sendemailbusinesspdf(<?php echo $this->_tpl_vars['ID']; ?>
)">Business loan <?php echo $this->_tpl_vars['APP']['LBL_SENDMAIL_BUTTON_LABEL']; ?>
 PDF app</a>
																	</td>
																	</tr>
																	<tr>
																<td td align="left" style="padding-left:10px;">
																<a href="javascript:void(0);" class="webMnu" onclick="sendemailpdffax(<?php echo $this->_tpl_vars['ID']; ?>
)"><img src="<?php echo vtiger_imageurl('sendmail.png', $this->_tpl_vars['THEME']); ?>
" hspace="5" align="absmiddle"  border="0"/></a>&nbsp;
																		<a href="javascript:void(0);" class="webMnu" onclick="sendemailpdffax(<?php echo $this->_tpl_vars['ID']; ?>
)">Fax loan PDF app</a>
																	...
																	<tr>
																<td td align="left" style="padding-left:10px;">
																<a href="javascript:void(0);" class="webMnu" onclick="sendemailbusinesspdffax(<?php echo $this->_tpl_vars['ID']; ?>
)"><img src="<?php echo vtiger_imageurl('sendmail.png', $this->_tpl_vars['THEME']); ?>
" hspace="5" align="absmiddle"  border="0"/></a>&nbsp;
																		<a href="javascript:void(0);" class="webMnu" onclick="sendemailbusinesspdffax(<?php echo $this->_tpl_vars['ID']; ?>
)">Fax Business loan PDF app</a>
																	</td>
																	</tr>
																<?php endif; ?>
															<?php endif; ?>
...
?>
															...
															<?php if ($this->_tpl_vars['customlink_label'] != 'LBL_ADD_NOTE'): ?>
															<tr>
																<td align="left" style="padding-left:10px;">
...
"><?php echo $this->_tpl_vars['customlink_label']; ?>
												...
												<?php endif; ?>
<?php if ($this->_tpl_vars['MODULE'] == 'Leads'): ?><?php echo $this->_tpl_vars['LAST7COMMENT']; ?>
<?php endif; ?>
