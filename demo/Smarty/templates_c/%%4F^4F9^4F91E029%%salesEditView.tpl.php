<?php /* Smarty version 2.6.18, created on 2013-10-21 04:33:32
...
" class="crmbutton small save" onclick="this.form.action.value='Save';  if(formValidate())AjaxDuplicateValidate('Accounts','accountname',this.form);" type="button" name="button" value="  <?php echo $this->_tpl_vars['APP']['LBL_SAVE_BUTTON_LABEL']; ?>
  " style="width:70px" >
												...
												<?php elseif ($this->_tpl_vars['MODULE'] == 'Leads'): ?>
													<input title="<?php echo $this->_tpl_vars['APP']['LBL_SAVE_BUTTON_TITLE']; ?>
" accessKey="<?php echo $this->_tpl_vars['APP']['LBL_SAVE_BUTTON_KEY']; ?>
" class="crmButton small save" onclick="this.form.action.value='Save'; displaydeleted(); return validationform(); " type="button" name="button" value="  <?php echo $this->_tpl_vars['APP']['LBL_SAVE_BUTTON_LABEL']; ?>
  " style="width:70px" >
												<?php else: ?>
													<input title="<?php echo $this->_tpl_vars['APP']['LBL_SAVE_BUTTON_TITLE']; ?>
" accessKey="<?php echo $this->_tpl_vars['APP']['LBL_SAVE_BUTTON_KEY']; ?>
...
?>
							...
							<?php endif; ?>
										...
										<td colspan=2 class="detailedViewHeader">
                                        										...
                                        										<?php elseif ($this->_tpl_vars['MODULE'] == 'Leads'): ?>
											<?php if ($this->_tpl_vars['header'] == 'Description Information' || $this->_tpl_vars['header'] == 'Contract Out' || $this->_tpl_vars['header'] == 'Funded'): ?>
												<?php if ($this->_tpl_vars['header'] == 'Description Information'): ?>
													<?php $this->assign('idheader', 'descriptionheader'); ?>
												<?php elseif ($this->_tpl_vars['header'] == 'Contract Out'): ?>
													<?php $this->assign('idheader', 'contractoutheader'); ?>
													<?php $this->assign('idrow', 'rowcontractout'); ?>
												<?php elseif ($this->_tpl_vars['header'] == 'Funded'): ?>
													<?php $this->assign('idheader', 'fundedheader'); ?>
													<?php $this->assign('idrow', 'rowfunded'); ?>
												<?php endif; ?>
												<td colspan=4 class="detailedViewHeader" style="display:none;" id="<?php echo $this->_tpl_vars['idheader']; ?>
">
												<b><?php echo $this->_tpl_vars['header']; ?>
</b>
												<?php $this->assign('i', 1); ?>
