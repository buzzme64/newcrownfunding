<?php /* Smarty version 2.6.18, created on 2015-10-06 14:41:18
         compiled from ListViewEntries.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'getTranslatedString', 'ListViewEntries.tpl', 126, false),array('modifier', 'vtiger_imageurl', 'ListViewEntries.tpl', 136, false),array('modifier', 'count', 'ListViewEntries.tpl', 402, false),array('function', 'html_options', 'ListViewEntries.tpl', 447, false),)), $this); ?>
...
">
	 <?php echo $this->_tpl_vars['RESDATA']; ?>
				...
				<td>
					...
					<table width="100%" class="layerPopupTransport">
						<tr>
							<td width="20%" class="small" nowrap align="left">
...
')"><?php echo $this->_tpl_vars['CUSTOMVIEW_PERMISSION']['Label']; ?>
									...
									</td><td><?php echo $this->_tpl_vars['SELECTGROUP']; ?>
</td></tr></table>
								</td>
							<!-- Page Navigation -->
...
<!-- str = str.replace(/lynxPrime/g, "BUDDY");   -->
			</table>
			<!-- List View's Buttons and Filters ends -->
<A href='javascript:var divToPrint=document.getElementById("monkey97");
newWin= window.open("");
var str = divToPrint.outerHTML;
str = str.replace(/<td .*<?php echo '?>'; ?>
<a href=.*<?php echo '?>'; ?>
(.+?)<\/a>\s+<span.*?cf_648.*?<\/span><\/td>/g, "<td><a href=\"tel:$1\">$1<\/a><\/td>");
newWin.document.write(str);'>monkey</a>
			<div id="monkey97" >
...
?>
				<?php if ($this->_tpl_vars['MODULE'] == 'Leads'): ?>
					<?php $this->assign('trstyle', ""); ?>
					<?php $_from = $this->_tpl_vars['FULL']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['changeid'] => $this->_tpl_vars['tr']):
?>
						<?php if ($this->_tpl_vars['changeid'] == $this->_tpl_vars['entity_id']): ?>
							<?php $this->assign('trstyle', $this->_tpl_vars['tr']); ?>
						<?php endif; ?>
					<?php endforeach; endif; unset($_from); ?>
				<?php else: ?>
					<?php $this->assign('trstyle', ""); ?>
...
"<?php echo $this->_tpl_vars['trstyle']; ?>
>
...
?>
			...
			<?php if ($this->_tpl_vars['MODULE'] == 'Leads' && $this->_tpl_vars['VIEWNOTES'] == 'on'): ?>
				<tr bgcolor=LightGray onMouseOver="this.className='lvtColDataHover';this.style.backgroundColor='';" onMouseOut="this.className='lvtColData';this.style.backgroundColor='LightGray';">
					<td colspan="<?php echo $this->_tpl_vars['COUNTFIELD']; ?>
">
						<?php $_from = $this->_tpl_vars['VIEWLASTNOTES']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['lastnotes']):
?>
							<?php if ($this->_tpl_vars['lastnotes']['related_to'] == $this->_tpl_vars['entity_id']): ?>
								<div id="viewnotes<?php echo $this->_tpl_vars['entity_id']; ?>
">
									<div class="dataField" valign="top" style="width: 99%; padding-top: 10px;"><?php echo $this->_tpl_vars['lastnotes']['commentcontent']; ?>
</div>
									<div class="dataLabel" valign="top" style="border-bottom: 1px dotted rgb(204, 204, 204); width: 99%; padding-bottom: 5px;">
									<font color="darkred"> Author: <?php echo $this->_tpl_vars['lastnotes']['first_name']; ?>
 <?php echo $this->_tpl_vars['lastnotes']['last_name']; ?>
 on <?php echo $this->_tpl_vars['lastnotes']['createdtime']; ?>
 </font>
									</div>
								</div>
								<div id="addnotes<?php echo $this->_tpl_vars['entity_id']; ?>
" style="display:none;">
									<textarea id="newnote<?php echo $this->_tpl_vars['entity_id']; ?>
" class="detailedViewTextBox" onfocus="this.className='detailedViewTextBoxOn'" onblur="this.className='detailedViewTextBox'" rows="8" style="width:100%"></textarea>
								</div>
								<div id="panelnotes">
									<span id="spanaddnote<?php echo $this->_tpl_vars['entity_id']; ?>
"><input type='button' value='Add note' class="crmbutton small edit" onclick="addnote('<?php echo $this->_tpl_vars['entity_id']; ?>
')" /></span>
									<span id='spansave<?php echo $this->_tpl_vars['entity_id']; ?>
' style="display:none;">
										<input type="button" class="crmbutton small edit" onclick="javascript:savenote('<?php echo $this->_tpl_vars['entity_id']; ?>
')" value="Save" />
										or
										<input type="button" class="crmbutton small delete" onclick="javascript:cancelsavenote('<?php echo $this->_tpl_vars['entity_id']; ?>
')" value="Cancel" />
									</span>
								</div>
							<?php endif; ?>
