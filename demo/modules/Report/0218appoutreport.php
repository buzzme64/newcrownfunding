...
//BNJ added cf_735 below
	$query="select crm.smownerid, l.leadid, l.firstname, l.lastname, lcf.cf_641 dba, lcf.cf_735,ifnull(lcf.cf_736,crm.modifiedtime)  as changeassigned
	from vtiger_leaddetails l
	inner join vtiger_leadscf lcf on l.leadid=lcf.leadid
	inner join vtiger_crmentity crm on l.leadid=crm.crmid
	where crm.deleted=0  AND l.converted =0 and l.leadstatus='2. App Out'";
	if ($startdate!='') $query.=" and ifnull(lcf.cf_736,crm.modifiedtime)  >='".$startdaten."'";
	if ($enddate!='') $query.=" and ifnull(lcf.cf_736,crm.modifiedtime)  <='".$enddaten."'";
