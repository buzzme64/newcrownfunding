<?php /* Smarty version 2.6.18, created on 2014-12-18 13:53:51
...
>
   ...
   <?php echo $this->_tpl_vars['APP']['LBL_REQUIRED_SYMBOL']; ?>
    ...
    <?php echo $this->_tpl_vars['APP']['LBL_REQUIRED_SYMBOL']; ?>
		   ...
		   <td><select name="column10" id="column10" onChange="checkDuplicate();" class="small">
                        <option value=""><?php echo $this->_tpl_vars['MOD']['LBL_NONE']; ?>
</option>
                        <?php $_from = $this->_tpl_vars['CHOOSECOLUMN10']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['label'] => $this->_tpl_vars['filteroption']):
?>
                                <optgroup label="<?php echo $this->_tpl_vars['label']; ?>
" class=\"select\" style=\"border:none\">
   ...
   <?php echo $this->_tpl_vars['APP']['LBL_REQUIRED_SYMBOL']; ?>
    ...
    <?php echo $this->_tpl_vars['APP']['LBL_REQUIRED_SYMBOL']; ?>
                        ...
                        <?php endif; ?>
                                ...
                                <?php endforeach; endif; unset($_from); ?>
                        <?php endforeach; endif; unset($_from); ?>
                        <?php echo $this->_tpl_vars['CHOOSECOLUMN10']; ?>
