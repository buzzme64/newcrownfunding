...
if (isset($_REQUEST['leadid'])){
	...
	It was a pleasure speaking with you earlier. As I mentioned, we are a funding bank and not a broker. As a direct lending bank, we have lower rates 
	and more repayment options than our competitors. We can fund in 24-48 hours once the signed agreement is received from you. Please call me with any and
	 ALL questions you have at any time as I am easily reached at the numbers on my e-card below. 


	Please send in the attached application along with:<br /> 

		
			Your 3 most recent bank statements.
	
		
			Your 3 most recent credit card processing statements (if applicable)
			
			
	

	We will process the application immediately and get you the loan offer that will meet your financial needs. I am looking forward to 
	working with you and being a part of your continued success!
</p>
