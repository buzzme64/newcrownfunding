			...
			<td>
				...
				<tr>
					...
					{if $CHECK.index eq 'yes' && $MODULE neq 'Emails' && $MODULE neq 'Webmails'}
						 <td style="padding-right:10px"><a href="index.php?module=Leads&action=newaddlead"><img src="{$IMAGE_PATH}btnL3Search.gif" alt="{$APP.LBL_SEARCH_ALT}{$MODULE|getTranslatedString:$MODULE}..." title="{$APP.LBL_SEARCH_TITLE}{$MODULE|getTranslatedString:$MODULE}..." border=0></a></a></td>
					{else}
						<td style="padding-right:10px"><img src="{'btnL3Search-Faded.gif'|@vtiger_imageurl:$THEME}" border=0></td>
					{/if}
					<!--<td style="padding-right:0px;padding-left:10px;"><a href="index.php?module=Leads&action=newaddlead"><img src="{'btnL3Add-Faded.gif'|@vtiger_imageurl:$THEME}"></a></td>
                	   		-->	
				</tr>
				</table>
			</td>
