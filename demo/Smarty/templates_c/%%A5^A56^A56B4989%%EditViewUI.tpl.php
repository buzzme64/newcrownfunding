<?php /* Smarty version 2.6.18, created on 2015-05-27 14:09:58
         compiled from EditViewUI.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'vtiger_imageurl', 'EditViewUI.tpl', 34, false),array('modifier', 'getTranslatedString', 'EditViewUI.tpl', 66, false),array('modifier', 'getTranslatedCurrencyString', 'EditViewUI.tpl', 467, false),array('modifier', 'substr', 'EditViewUI.tpl', 524, false),)), $this); ?>
		...
		<?php if ($this->_tpl_vars['MODULE'] == 'Leads'): ?>
			<?php $this->assign('tdstyle', ($this->_tpl_vars['maindata'][7])); ?>
		<?php else: ?>
			<?php $this->assign('tdstyle', ""); ?>
		<?php endif; ?>
...
" <?php endif; ?> class=detailedViewTextBox onFocus="this.className='detailedViewTextBoxOn'" onBlur="this.className='detailedViewTextBox'"></td>
		<?php elseif ($this->_tpl_vars['uitype'] == 11 || $this->_tpl_vars['uitype'] == 1 || $this->_tpl_vars['uitype'] == 13 || $this->_tpl_vars['uitype'] == 7): ?>
			<td data-side="toremove" width=20% class="dvtCellLabel" align=right<?php echo $this->_tpl_vars['tdstyle']; ?>
><font color="red"><?php echo $this->_tpl_vars['mandatory_field']; ?>
</font><?php echo $this->_tpl_vars['usefldlabel']; ?>
 <?php if ($this->_tpl_vars['MASS_EDIT'] == '1'): ?><input type="checkbox" name="<?php echo $this->_tpl_vars['fldname']; ?>
_mass_edit_check" id="<?php echo $this->_tpl_vars['fldname']; ?>
...
" border="0"></span>
			...
			<?php else: ?>
				<td data-side="toremove" width=30% align=left class="dvtCellInfo"><input type="text" tabindex="<?php echo $this->_tpl_vars['vt_tab']; ?>
" name="<?php echo $this->_tpl_vars['fldname']; ?>
" id ="<?php echo $this->_tpl_vars['fldname']; ?>
" value="<?php echo $this->_tpl_vars['fldvalue']; ?>
...
'>
		...
		<?php elseif ($this->_tpl_vars['uitype'] == 21 || $this->_tpl_vars['uitype'] == 24): ?>
			<td width=20% class="dvtCellLabel" align=right<?php echo $this->_tpl_vars['tdstyle']; ?>
>
					<font color="red"><?php echo $this->_tpl_vars['mandatory_field']; ?>
</font>
				<?php echo $this->_tpl_vars['usefldlabel']; ?>
...
_mass_edit_check" class="small" ><?php endif; ?>
			...
			<td <?php if ($this->_tpl_vars['MODULE'] == 'Leads' && $this->_tpl_vars['uitype'] == '15' && $this->_tpl_vars['usefldlabel'] == 'Lead Status'): ?>colspan="3"<?php else: ?>width="30%"<?php endif; ?> align=left class="dvtCellInfo">
			<?php if ($this->_tpl_vars['MODULE'] == 'Leads' && $this->_tpl_vars['uitype'] == '15' && $this->_tpl_vars['usefldlabel'] == 'Lead Status'): ?>
				<?php $this->assign('existselect', false); ?>
				<?php $this->assign('appnotsend', false); ?>
...
?>
					<?php if ($this->_tpl_vars['arr'][2] == 'selected'): ?>
					<?php $this->assign('existselect', true); ?>
						<?php if ($this->_tpl_vars['arr'][0] == '1. App not sent' || $this->_tpl_vars['arr'][0] == 'Lead Pending'): ?>
							<?php $this->assign('appnotsend', true); ?>
						<?php endif; ?>
					<?php endif; ?>
				<?php endforeach; endif; unset($_from); ?>
				<?php $this->assign('currstep', true); ?>
				<?php $this->assign('nextstep', false); ?>
				<?php $_from = $this->_tpl_vars['fldvalue']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['arr']):
?>
					<?php if ($this->_tpl_vars['existselect'] == false): ?>
						<?php if ($this->_tpl_vars['arr'][0] == 'Lead Pending'): ?>
							<input type='radio' name="<?php echo $this->_tpl_vars['fldname']; ?>
" value="<?php echo $this->_tpl_vars['arr'][0]; ?>
" checked="" onclick="hideviewdescription(this.value)" />
						<?php else: ?>
							<input type='radio' name="<?php echo $this->_tpl_vars['fldname']; ?>
" value="<?php echo $this->_tpl_vars['arr'][0]; ?>
" onclick="hideviewdescription(this.value)" />
						<?php endif; ?>
					<?php elseif ($this->_tpl_vars['appnotsend'] == true): ?>
						<?php if ($this->_tpl_vars['arr'][2] == 'selected'): ?>
							<input type='radio' name="<?php echo $this->_tpl_vars['fldname']; ?>
" value="<?php echo $this->_tpl_vars['arr'][0]; ?>
" checked="" onclick="hideviewdescription(this.value)" />
...
" onclick="hideviewdescription(this.value)" />
						<?php endif; ?>
					<?php else: ?>
						<?php if ($this->_tpl_vars['arr'][0] == '1. App not sent' && $this->_tpl_vars['existselect'] == false): ?>
							<input type='radio' name="<?php echo $this->_tpl_vars['fldname']; ?>
" value="<?php echo $this->_tpl_vars['arr'][0]; ?>
" checked="" onclick="hideviewdescription(this.value)" />
						<?php else: ?>
							<?php if ($this->_tpl_vars['arr'][0] == '10. Declined' || $this->_tpl_vars['arr'][0] == 'Lead Pending' || $this->_tpl_vars['arr'][0] == '9. Merchant Pass'): ?>
								<input type='radio' name="<?php echo $this->_tpl_vars['fldname']; ?>
" value="<?php echo $this->_tpl_vars['arr'][0]; ?>
"<?php if ($this->_tpl_vars['arr'][2] == 'selected'): ?> checked=""<?php endif; ?> onclick="hideviewdescription(this.value)" />
								<?php if ($this->_tpl_vars['arr'][2] == 'selected'): ?>
									<?php $this->assign('nextstep', false); ?>
								<?php endif; ?>
							<?php else: ?>
								<?php if ($this->_tpl_vars['arr'][2] == 'selected'): ?>
									<?php $this->assign('nextstep', true); ?>
									<input type='radio' name="<?php echo $this->_tpl_vars['fldname']; ?>
" value="<?php echo $this->_tpl_vars['arr'][0]; ?>
"<?php if ($this->_tpl_vars['currstep'] == true): ?> checked=""<?php endif; ?> onclick="hideviewdescription(this.value)" />
									<?php $this->assign('currstep', false); ?>
								<?php elseif ($this->_tpl_vars['existselect'] == true): ?>
									<input type='radio' name="<?php echo $this->_tpl_vars['fldname']; ?>
" value="<?php echo $this->_tpl_vars['arr'][0]; ?>
"<?php if ($this->_tpl_vars['currstep'] == true): ?> checked=""<?php endif; ?><?php if ($this->_tpl_vars['nextstep'] == false): ?> disabled=""<?php endif; ?> onclick="hideviewdescription(this.value)" />
									<?php $this->assign('nextstep', false); ?>
								<?php else: ?>
									<input type='radio' name="<?php echo $this->_tpl_vars['fldname']; ?>
" value="<?php echo $this->_tpl_vars['arr'][0]; ?>
"<?php if ($this->_tpl_vars['nextstep'] == false): ?> disabled=""<?php endif; ?> onclick="hideviewdescription(this.value)" />
								<?php endif; ?>
							<?php endif; ?>
						<?php endif; ?>
					<?php endif; ?>
...
<input type="checkbox" name="salutationtype_mass_edit_check" id="salutationtype_mass_edit_check" class="small" ><br />
			...
			<?php if ($this->_tpl_vars['uitype'] == 55): ?>
				<?php if ($this->_tpl_vars['usefldlabel'] == 'First Name' && $this->_tpl_vars['MODULE'] == 'Leads'): ?><font color="red"><?php echo $this->_tpl_vars['mandatory_field']; ?>
</font><?php endif; ?><?php echo $this->_tpl_vars['usefldlabel']; ?>
<?php if ($this->_tpl_vars['MASS_EDIT'] == '1'): ?><input type="checkbox" name="<?php echo $this->_tpl_vars['fldname']; ?>
_mass_edit_check" id="<?php echo $this->_tpl_vars['fldname']; ?>
_mass_edit_check" class="small" ><?php endif; ?>
...
_mass_edit_check" class="small" ><?php endif; ?>
			...
			<?php if ($this->_tpl_vars['fldvalue'] != ''): ?>
				<?php if ($this->_tpl_vars['uitype'] == 55 && $this->_tpl_vars['MODULE'] == 'Leads'): ?><span style="display: none;"><?php endif; ?>
...
>
				...
				<?php if ($this->_tpl_vars['uitype'] == 55 && $this->_tpl_vars['MODULE'] == 'Leads'): ?></span><?php endif; ?>
...
_hidden');
		...
		<div>
			<span style="display:none"><br><input name="<?php echo $this->_tpl_vars['fldname']; ?>
" id="<?php echo $this->_tpl_vars['fldname']; ?>
...
"/>
			<input type="hidden" name="id" value=""/>
			<input style="margin:12px 0;" type="text" id="<?php echo $this->_tpl_vars['fldname']; ?>
...
_value" style="display:none;">
		...
		<input id="dropFileSize" type="hidden" name="dropFileSize" value="" >
		<input id="dropFileName" type="hidden" name="dropFileName" value="" >
		<input id="dropFileType" type="hidden" name="dropFileType" value="" >
	...
	<span class="btn btn-success fileinput-button">
        ...
        <input id="fileupload" type="file" name="files[]" multiple="">
			...
			<br>
			<br>
			<div id="dropzone" class="well" style="margin:0;padding:50px 0;text-align:center;vertical-align:middle;">Drop files here</div>
			<br>
...
<script language="JavaScript" type="text/javascript" src="/powerline/drop/js/vendor/jquery.ui.widget.js"></script>
<script language="JavaScript" type="text/javascript" src="/powerline/drop/js/jquery.iframe-transport.js"></script>
<script language="JavaScript" type="text/javascript" src="/powerline/drop/js/jquery.fileupload.js"></script>
<script type="text/javascript">
  $(function () {

  	$(\'[data-side="toremove"]\').remove();
  // Change this to the location of your server-side upload handler:
    var url = \'http://104.131.243.213/vtiger/powerline/drop/php/\';
    $(\'#fileupload\').fileupload({
		...
		success : function(data){
			$(\'#dropFileName\').val(data.files[0].name);
			$(\'#dropFileSize\').val(data.files[0].size);
			$(\'#dropFileType\').val(data.files[0].type);

			var docName = data.files[0].name;
			docName = docName.split(\'.\');
			$(\'input[name="notes_title"]\').val(docName[0]);
