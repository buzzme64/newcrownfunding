<?php /* Smarty version 2.6.18, created on 2015-08-06 15:48:38
         compiled from Header.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'getTranslatedString', 'Header.tpl', 15, false),array('modifier', 'vtiger_imageurl', 'Header.tpl', 91, false),array('modifier', 'escape', 'Header.tpl', 159, false),array('modifier', 'vtlib_purify', 'Header.tpl', 359, false),)), $this); ?>
...
");</style>
	...
	<link rel="stylesheet" href="/powerline/drop/jquery.fileupload-ui.css">
...
" border=0 style="width: 50px;height: 50px;"></td>
...
info.PNG" border=0 style="padding: 0px;padding-left:5px"></a></td>
				<?php if ($this->_tpl_vars['ADMIN_LINK'] != '' && $this->_tpl_vars['ROLEID'] == 'H2'): ?>
...
?>
					...
					<?php if ($this->_tpl_vars['modulename'] == 'Report' && $this->_tpl_vars['ROLEID'] != 'H2'): ?><?php else: ?>
...
<!--
<table class="searchUIBasic small" width="98%" cellspacing="0" cellpadding="5" border="0" align="center" style="margin: 15px;margin-bottom: 0px;"><tr>
