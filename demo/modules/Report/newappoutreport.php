...
//BNJ added cf_735 below
	...
	$query="select crm.smownerid, l.leadid, l.firstname, l.lastname, lcf.cf_641 dba,lcf.cf_734,crm.modifiedtime , lcf.cf_735, lcf.cf_736 as stat_date,lcf.cf_735
	from vtiger_leaddetails l
	inner join vtiger_leadscf lcf on l.leadid=lcf.leadid
	inner join vtiger_crmentity crm on l.leadid=crm.crmid
	...
	$query.=" and crm.createdtime   >='".$startdaten."'";
	$query.=" and crm.createdtime  <='".$enddaten."'";
...
foreach($restable as $key=>$value){
 ...
 <td style='font-weight:bold;'>SubTotal:</td>
        ...
        <td style='font-weight:bold;'>".setpointtonumber($subtotal)." Deals</td></tr></table><table class=\"lvt small\" width=\"60%\" cellspacing=\"1\" cellpadding=\"3\" border=\"0\"><tr>";
