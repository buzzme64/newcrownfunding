<?php /* Smarty version 2.6.18, created on 2013-10-04 06:46:00
         compiled from EditViewHidden.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'vtlib_purify', 'EditViewHidden.tpl', 89, false),)), $this); ?>
...
<?php elseif ($this->_tpl_vars['MODULE'] == 'Documents'): ?>
	...
	<form name="EditView" method="POST" ENCTYPE="multipart/form-data" action="index.php" onsubmit="VtigerJS_DialogBox.block();" class="dropzone">
