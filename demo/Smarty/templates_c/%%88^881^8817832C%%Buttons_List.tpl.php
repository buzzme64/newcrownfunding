<?php /* Smarty version 2.6.18, created on 2015-09-11 17:09:48
...
btnL3Add_lead.gif" alt="<?php echo $this->_tpl_vars['APP']['LBL_CREATE_BUTTON_LABEL']; ?>
...
" border=0></td>	
					...
					<?php if ($this->_tpl_vars['CHECK']['index'] == 'yes' && $this->_tpl_vars['MODULE'] != 'Emails' && $this->_tpl_vars['MODULE'] != 'Webmails'): ?>
						 <td style="padding-right:10px"><a href="index.php?module=Leads&action=newaddlead"><img src="<?php echo $this->_tpl_vars['IMAGE_PATH']; ?>
...
" border=0></td>
					<?php endif; ?>
					<!--<td style="padding-right:0px;padding-left:10px;"><a href="index.php?module=Leads&action=newaddlead"><img src="<?php echo vtiger_imageurl('btnL3Add-Faded.gif', $this->_tpl_vars['THEME']); ?>
"></a></td>
                	   		-->	
				</tr>
				</table>
