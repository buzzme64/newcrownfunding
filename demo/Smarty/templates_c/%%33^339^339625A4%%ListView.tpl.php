<?php /* Smarty version 2.6.18, created on 2013-11-22 06:54:29
         compiled from ListView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'vtiger_imageurl', 'ListView.tpl', 197, false),array('function', 'html_options', 'ListView.tpl', 232, false),)), $this); ?>
...
" border=0>&nbsp;&nbsp;-->
		...
		<td class="small"<?php if ($this->_tpl_vars['MODULE'] == 'Leads'): ?> style="text-align: center; width:125px;"<?php endif; ?>><input type="text"  class="txtBox" style="width:120px;" name="search_text"></td>
		<td class="small" nowrap <?php if ($this->_tpl_vars['MODULE'] == 'Leads'): ?>style="display:none;"<?php endif; ?>><b><?php echo $this->_tpl_vars['APP']['LBL_IN']; ?>
</b>&nbsp;</td>
		<td class="small" nowrap<?php if ($this->_tpl_vars['MODULE'] == 'Leads'): ?> style="display:none;"<?php endif; ?>>
			<div id="basicsearchcolumns_real">
			<select name="search_field" id="bas_searchfield" class="txtBox" style="width:150px;<?php if ($this->_tpl_vars['MODULE'] == 'Leads'): ?>display:none;<?php endif; ?>">
...
">
 ...
 ">&nbsp;
	...
	<tr>
		<td colspan="7" align="center" class="small" style="display: none;">
			<table border=0 cellspacing=0 cellpadding=0 width=100%>
				<tr>
