...
require_once('include/utils/CommonUtils.php');   //BNJ
...
$bnjisadmin = is_admin($current_user) ? "Y" : "N";  //BNJ
...
';
		//BNJ if ($current_user->column_fields['is_admin']=="on")   //BNJ
		if ($bnjisadmin == "Y")   //BNJ
...
function sendemailbusinesspdf(id){	
	window.open('index.php?module=Leads&action=LeadsAjax&file=newviewmail&leadid=' + id,'','toolbar=no,location=no,directories=no,status=no,scrollbars=no,resizable=no,copyhistory=no,width=800,height=600');
}
function sendemailbusinesspdffax(id){	
	window.open('index.php?module=Leads&action=LeadsAjax&file=newviewmailfax&leadid=' + id,'','toolbar=no,location=no,directories=no,status=no,scrollbars=no,resizable=no,copyhistory=no,width=800,height=600');
}
function sendemailpdffax(id){	
	window.open('index.php?module=Leads&action=LeadsAjax&file=viewmailfax&leadid=' + id,'','toolbar=no,location=no,directories=no,status=no,scrollbars=no,resizable=no,copyhistory=no,width=800,height=600');
}
