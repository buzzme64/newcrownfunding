<?php /* Smarty version 2.6.18, created on 2013-11-25 03:56:01
...
');">
			...
			<option value="Last7" <?php if ($this->_tpl_vars['CRITERIA'] == 'Last7'): ?>selected<?php endif; ?>><?php echo $this->_tpl_vars['MOD']['LBL_LAST7']; ?>
</option>
...
" class="detailedViewTextBox" onFocus="this.className='detailedViewTextBoxOn'" onBlur="this.className='detailedViewTextBox'" cols="90" rows="8"></textarea>
			...
			<input type="button" class="crmbutton small save" value="<?php echo $this->_tpl_vars['APP']['LBL_SAVE_LABEL']; ?>
" onclick="newcomment('<?php echo $this->_tpl_vars['ID']; ?>
','widget')"/> 
			<?php else: ?>
			<input type="button" class="crmbutton small save" value="<?php echo $this->_tpl_vars['APP']['LBL_SAVE_LABEL']; ?>
