<?php /* Smarty version 2.6.18, created on 2014-02-25 04:08:45
         compiled from DetailViewUI.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'count', 'DetailViewUI.tpl', 37, false),array('modifier', 'vtiger_imageurl', 'DetailViewUI.tpl', 49, false),array('modifier', 'getTranslatedCurrencyString', 'DetailViewUI.tpl', 60, false),array('modifier', 'cat', 'DetailViewUI.tpl', 203, false),array('modifier', 'replace', 'DetailViewUI.tpl', 208, false),array('modifier', 'wordwrap', 'DetailViewUI.tpl', 210, false),array('modifier', 'regex_replace', 'DetailViewUI.tpl', 270, false),array('modifier', 'parse_calendardate', 'DetailViewUI.tpl', 443, false),)), $this); ?>
...
');" onmouseout="fnhide('crmspanid');" valign="top"<?php echo $this->_tpl_vars['tdstyle']; ?>
>
				<?php if ($this->_tpl_vars['keyid'] == '55' || $this->_tpl_vars['keyid'] == '255'): ?><!--SalutationSymbol-->
					...
					<?php else: ?>
						<span style="display: none;"><?php echo $this->_tpl_vars['keysalut']; ?>
</span>
					<?php endif; ?>
				<?php endif; ?>
...
" onmouseover="hndMouseOver(<?php echo $this->_tpl_vars['keyid']; ?>
,'<?php echo $this->_tpl_vars['label']; ?>
');" onmouseout="fnhide('crmspanid');"<?php echo $this->_tpl_vars['tdstyle']; ?>
><span id="dtlview_<?php echo $this->_tpl_vars['label']; ?>
">
...
" type="button" class="crmbutton small save" value="<?php echo $this->_tpl_vars['APP']['LBL_SAVE_LABEL']; ?>
" onclick="SaveEmail('<?php echo $this->_tpl_vars['label']; ?>
','<?php echo $this->_tpl_vars['MODULE']; ?>
',<?php echo $this->_tpl_vars['keyfldid']; ?>
,'<?php echo $this->_tpl_vars['keytblname']; ?>
','<?php echo $this->_tpl_vars['keyfldname']; ?>
...
####<?php echo $_SESSION['internal_mailer']; ?>
	...
	<?php elseif ($this->_tpl_vars['keyid'] == '15' || $this->_tpl_vars['keyid'] == '16' || $this->_tpl_vars['keyid'] == '31' || $this->_tpl_vars['keyid'] == '32'): ?> <!--ComboBox-->
		<?php if ($this->_tpl_vars['MODULE'] == 'Leads' && $this->_tpl_vars['label'] == 'Lead Status'): ?>
			<td class="dvtCellInfo" align="left" id="mouseArea_<?php echo $this->_tpl_vars['label']; ?>
" onmouseover="hndMouseOver(<?php echo $this->_tpl_vars['keyid']; ?>
,'<?php echo $this->_tpl_vars['label']; ?>
');" onmouseout="fnhide('crmspanid');"<?php echo $this->_tpl_vars['tdstyle']; ?>
>
...
?>
													<input type="radio" <?php if ($this->_tpl_vars['arr'][2] == 'selected'): ?>checked=""<?php else: ?>readonly="" disabled=""<?php endif; ?> /><?php echo $this->_tpl_vars['arr'][0]; ?>
									<?php endforeach; endif; unset($_from); ?>
				</span>
						<?php else: ?>
						<?php $_from = $this->_tpl_vars['keyoptions']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
...
<?php endif; ?></font></span>
		<?php endif; ?>
													<div id="editarea_<?php echo $this->_tpl_vars['label']; ?>
" style="display:none;">
		<?php if ($this->_tpl_vars['MODULE'] == 'Leads' && $this->_tpl_vars['keyid'] == '15' && $this->_tpl_vars['label'] == 'Lead Status'): ?>
...
?>
				<?php if ($this->_tpl_vars['arr'][2] == 'selected'): ?>
					...
					<?php $this->assign('viewsave', $this->_tpl_vars['arr'][0]); ?>
					<input type="hidden" name="hidezone" value="<?php echo $this->_tpl_vars['arr'][0]; ?>
" id="hidezone" />
					<?php if ($this->_tpl_vars['arr'][0] == '1. App not sent' || $this->_tpl_vars['arr'][0] == 'Lead Pending' || $this->_tpl_vars['arr'][0] == '10. Follow ups'): ?>
...
?>
				<?php if ($this->_tpl_vars['existselect'] == false): ?>
					<?php if ($this->_tpl_vars['arr'][0] == '1. App not sent'): ?>
						<input type='radio' name="<?php echo $this->_tpl_vars['keyfldname']; ?>
" value="<?php echo $this->_tpl_vars['arr'][0]; ?>
" checked="" onclick="changeleadstatus('<?php echo $this->_tpl_vars['arr'][0]; ?>
')" />
					<?php else: ?>
						<input type='radio' name="<?php echo $this->_tpl_vars['keyfldname']; ?>
" value="<?php echo $this->_tpl_vars['arr'][0]; ?>
" onclick="changeleadstatus('<?php echo $this->_tpl_vars['arr'][0]; ?>
')" />
					<?php endif; ?>
...
',false)" />
					<?php else: ?>
						<?php if ($this->_tpl_vars['arr'][0] == '9. Declined' || $this->_tpl_vars['arr'][0] == 'Lead Pending' || $this->_tpl_vars['arr'][0] == '8. Merchant Pass' || $this->_tpl_vars['arr'][0] == '10. Follow ups'): ?>
							<input type='radio' name="<?php echo $this->_tpl_vars['keyfldname']; ?>
" value="<?php echo $this->_tpl_vars['arr'][0]; ?>
"<?php if ($this->_tpl_vars['arr'][2] == 'selected'): ?> checked=""<?php endif; ?> onclick="changeleadstatus('<?php echo $this->_tpl_vars['arr'][0]; ?>
')" />
							<?php if ($this->_tpl_vars['arr'][2] == 'selected'): ?>
								<?php $this->assign('nextstep', false); ?>
							<?php endif; ?>
						<?php else: ?>
							<?php if ($this->_tpl_vars['arr'][2] == 'selected'): ?>
								...
								<input type='radio' name="<?php echo $this->_tpl_vars['keyfldname']; ?>
" value="<?php echo $this->_tpl_vars['arr'][0]; ?>
"<?php if ($this->_tpl_vars['currstep'] == true): ?> checked=""<?php endif; ?> onclick="changeleadstatus('<?php echo $this->_tpl_vars['arr'][0]; ?>
')" />
								<?php $this->assign('currstep', false); ?>
							<?php elseif ($this->_tpl_vars['existselect'] == true): ?>
								<input type='radio' name="<?php echo $this->_tpl_vars['keyfldname']; ?>
" value="<?php echo $this->_tpl_vars['arr'][0]; ?>
"<?php if ($this->_tpl_vars['currstep'] == true): ?> checked=""<?php endif; ?><?php if ($this->_tpl_vars['nextstep'] == false): ?> disabled=""<?php endif; ?> onclick="changeleadstatus('<?php echo $this->_tpl_vars['arr'][0]; ?>
')" />
								<?php $this->assign('nextstep', false); ?>
							<?php else: ?>
								<input type='radio' name="<?php echo $this->_tpl_vars['keyfldname']; ?>
" value="<?php echo $this->_tpl_vars['arr'][0]; ?>
"<?php if ($this->_tpl_vars['nextstep'] == false): ?> disabled=""<?php endif; ?> onclick="changeleadstatus('<?php echo $this->_tpl_vars['arr'][0]; ?>
')" />
							<?php endif; ?>
						<?php endif; ?>
					<?php endif; ?>
			...
			<input name="button_<?php echo $this->_tpl_vars['label']; ?>
" type="button" class="crmbutton small save" value="<?php echo $this->_tpl_vars['APP']['LBL_SAVE_LABEL']; ?>
" onclick="updateleadstatus('<?php echo $this->_tpl_vars['ID']; ?>
');"/> <?php echo $this->_tpl_vars['APP']['LBL_OR']; ?>
